          ...
          <div className="border-t border-[#eadeed] pt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-bold text-[#343230]">Espacio acondicionado</h5>
                  <p className="text-sm text-gray-500 mt-0.5">Un espacio destinado solo a quienes cubran el encuentro</p>
                </div>
              </div>
